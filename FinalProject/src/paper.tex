...
\begin{enumerate}
  ...
  \item groups answer \emph{images} by semantic similarity (no answer OCR\footnote{No answer OCR means that text extracted from the image is not returned in the answer. In this case the answer is a grouping, so text extracted by the AI is not needed.}),
